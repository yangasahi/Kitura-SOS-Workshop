...
Continue to the [next page](https://github.com/dokun1/kitua-safe-lab/blob/master/05-StatusReportsAndDisasters.md) to set up handling of Status Reports and Disasters.
